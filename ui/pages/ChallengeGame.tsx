  ...
  useEffect(() => {
    const resolveActiveData = async () => {
      ...
      const moviesToFetch = activeMovieIds.filter(mId => {
          ...
          // Only refetch if cast data is genuinely missing from the store object
      ...
      if (moviesToFetch.length > 0) {
          ...
          // Firing these in parallel ensures near-instant availability
      ...
      // 3. BACKGROUND RESOLUTION: Fetch all remaining movie IDs later in background
